...
namespace SchoolERP.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260526161120_RenamePlanValues")]
    partial class RenamePlanValues
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SchoolERP.Domain.Entities.AcademicPeriod", b =>
                {
                    ...
                    b.HasIndex("AcademicYearId", "PeriodNumber")
                        .IsUnique();
            ...
            modelBuilder.Entity("SchoolERP.Domain.Entities.Announcement", b =>
                {
                    ...
                    b.HasIndex("SchoolId", "Audience");

                    b.HasIndex("TenantId", "SchoolId", "IsPublished");
            ...
            modelBuilder.Entity("SchoolERP.Domain.Entities.Assignment", b =>
                {
                    ...
                    b.Property<bool>("HasPresentation")
                        .HasColumnType("boolean");
                    ...
                    b.HasIndex("SectionId", "AcademicPeriodId");
            ...
            modelBuilder.Entity("SchoolERP.Domain.Entities.AttendanceExcuse", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("attendance_excuses", (string)null);
                });
            ...
            modelBuilder.Entity("SchoolERP.Domain.Entities.DocumentRequirement", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<string>("AcceptedFileTypes")
                        ...
                        .HasMaxLength(100)
                        .HasColumnType("character varying(100)")
                        .HasDefaultValue("pdf,jpg,jpeg,png");
            ...
            modelBuilder.Entity("SchoolERP.Domain.Entities.Message", b =>
                {
                    ...
                    b.HasIndex("TenantId", "SenderId");

                    b.HasIndex("TenantId", "RecipientId", "IsRead");
            ...
            modelBuilder.Entity("SchoolERP.Domain.Entities.StudentDocument", b =>
                {
                    ...
                    b.HasIndex("StudentId", "RequirementId");
            ...
            modelBuilder.Entity("SchoolERP.Domain.Entities.StudentGuardian", b =>
                {
                    ...
                    b.Property<bool>("HasCustodyOrder")
                        .HasColumnType("boolean");
            ...
            modelBuilder.Entity("SchoolERP.Domain.Entities.StudentSubmission", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("SchoolERP.Domain.Entities.Teacher", b =>
                {
                    ...
                    b.HasIndex("TenantId", "MinerdCode")
                        .IsUnique()
            ...
            modelBuilder.Entity("SchoolERP.Domain.Entities.Announcement", b =>
                {
                    b.HasOne("SchoolERP.Domain.Entities.User", "Author")
                        .WithMany()
            ...
            modelBuilder.Entity("SchoolERP.Domain.Entities.AttendanceExcuse", b =>
                {
                    ...
                    b.HasOne("SchoolERP.Domain.Entities.User", "Reviewer")
                        .WithMany()
            ...
            modelBuilder.Entity("SchoolERP.Domain.Entities.Message", b =>
                {
                    ...
                    b.HasOne("SchoolERP.Domain.Entities.User", "Recipient")
                        .WithMany()
            ...
            modelBuilder.Entity("SchoolERP.Domain.Entities.StudentDocument", b =>
                {
                    b.HasOne("SchoolERP.Domain.Entities.DocumentRequirement", "Requirement")
