        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Country = table.Column<string>(type: "character varying(2)", maxLength: 2, nullable: false, defaultValue: "DO"),
                    ContactEmail = table.Column<string>(type: "character varying(256)", maxLength: 256, nullable: false),
                    ContactPhone = table.Column<string>(type: "character varying(20)", maxLength: 20, nullable: true),
                    Plan = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: false, defaultValue: "trial"),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CodeMinerd = table.Column<string>(type: "character varying(20)", maxLength: 20, nullable: true),
                    Rnc = table.Column<string>(type: "character varying(20)", maxLength: 20, nullable: true),
                    ...
                    PhonePrimary = table.Column<string>(type: "character varying(20)", maxLength: 20, nullable: true),
                    ...
                    LogoUrl = table.Column<string>(type: "character varying(500)", maxLength: 500, nullable: true),
                    SealUrl = table.Column<string>(type: "character varying(500)", maxLength: 500, nullable: true),
                    LevelType = table.Column<string>(type: "character varying(20)", maxLength: 20, nullable: false),
                    IsActive = table.Column<bool>(type: "boolean", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    CreatedBy = table.Column<Guid>(type: "uuid", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Nationality = table.Column<string>(type: "character varying(5)", maxLength: 5, nullable: true, defaultValue: "DO"),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EndDate = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    IsActive = table.Column<bool>(type: "boolean", nullable: false),
                    GradesPublished = table.Column<bool>(type: "boolean", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    CreatedBy = table.Column<Guid>(type: "uuid", nullable: true),
                    UpdatedBy = table.Column<Guid>(type: "uuid", nullable: true)
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    HomeTeacherId = table.Column<Guid>(type: "uuid", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SubjectId = table.Column<Guid>(type: "uuid", nullable: false),
                    AcademicPeriodId = table.Column<Guid>(type: "uuid", nullable: false),
                    EvaluationPlanId = table.Column<Guid>(type: "uuid", nullable: false),
                    TeacherId = table.Column<Guid>(type: "uuid", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_grade_entries_tenants_TenantId",
                        column: x => x.TenantId,
                        principalTable: "tenants",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_attendance_records_AcademicPeriodId",
                table: "attendance_records",
                column: "AcademicPeriodId");

            migrationBuilder.CreateIndex(
                name: "IX_attendance_records_SectionId_Date",
                table: "attendance_records",
                columns: new[] { "SectionId", "Date" });

            migrationBuilder.CreateIndex(
                name: "IX_attendance_records_StudentId_SectionId_Date",
                table: "attendance_records",
                columns: new[] { "StudentId", "SectionId", "Date" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_attendance_records_TeacherId",
                table: "attendance_records",
                column: "TeacherId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_grade_entries_AcademicPeriodId",
                table: "grade_entries",
                column: "AcademicPeriodId");

            migrationBuilder.CreateIndex(
                name: "IX_grade_entries_EvaluationPlanId",
                table: "grade_entries",
                column: "EvaluationPlanId");

            migrationBuilder.CreateIndex(
                name: "IX_grade_entries_StudentId_EvaluationPlanId",
                table: "grade_entries",
                columns: new[] { "StudentId", "EvaluationPlanId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_grade_entries_SubjectId_AcademicPeriodId",
                table: "grade_entries",
                columns: new[] { "SubjectId", "AcademicPeriodId" });

            migrationBuilder.CreateIndex(
                name: "IX_grade_entries_TeacherId",
                table: "grade_entries",
                column: "TeacherId");

            migrationBuilder.CreateIndex(
                name: "IX_grade_entries_TenantId",
                table: "grade_entries",
                column: "TenantId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_schools_TenantId_CodeMinerd",
                table: "schools",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_students_TenantId_NationalId",
                table: "students",
